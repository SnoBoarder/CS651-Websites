...
namespace TranMini.GameServer
{
	public class RegistrationHandler
	{
		...
		public RegisteredClient Register(string identity, string displayName)
		{
			RegisteredClient rc = new RegisteredClient(Guid.NewGuid().ToString(), identity, displayName);
